<template>
  <div class=" h-full w-full bg-gray-200 rounded-3xl p-4 font-semibold space-y-4 ">

    <!-- section-title -->
    <div class="flex flex-row justify-between items-center w-full ">
      <div class=" flex flex-row justify-start items-center gap-2 ">
        <h2 class=" text-xl  text-blackich-100   ">Reviwes</h2>
        <p class=" text-blackich-200 text-sm  ">(2500)</p>
      </div>
      <svg class=" rotate-90 " width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
    ...
    <div class=" w-full space-y-6 ">
      <ReviewsReview />
      <div class=" bg-gray-300 h-[2px] rounded-full w-full "></div>
      <ReviewsReview />
      <div class=" bg-gray-300 h-[2px] rounded-full w-full "></div>
      <ReviewsReview />
      <div class=" text-center text-blackich-200 text-lg w-full ">+ more</div>
    </div>
